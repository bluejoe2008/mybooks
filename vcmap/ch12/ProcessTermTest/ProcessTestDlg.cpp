...
BEGIN_MESSAGE_MAP(CProcessTestDlg, CDialog)
	...
	ON_BN_CLICKED(ID_KILL_EDITOR, &CProcessTestDlg::OnBnClickedKillEditor)
END_MESSAGE_MAP()
...
void CProcessTestDlg::OnBnClickedKillEditor()
{
	if(m_hNotePadProcess != NULL)
	{
		TerminateProcess(m_hNotePadProcess, -1);
